    ...
    <div class="index-container">
        <nav class="navbar">
            ...
            <div class="nav-links">
                ...
                <a href="pages/registration.php" class="nav-link">Sign Up</a>
            </div>
        </nav>
        <div class="content">
            <h2>Welcome to Our Site!</h2>
            <p>We're thrilled to have you here. Explore our amazing features<br> and discover what makes us unique.</p>
            <a href="pages/registration.php" class="link">Get Started &rarr;</a>
        </div>
        <footer>
            <p>&copy; <?php echo $date ?> My recipes. All rights reserved.</p>
